 ...
 * Se mostrará en un panel lateral o modal cuando el usuario interactúe
 * con el "edificio" de inventario en el mapa de Phaser.
 */
const InventoryUI = () => {
    ...
    const handleSendData = () => {
        ...
        console.log(`[InventoryUI] Enviando ${quantity} de ${item}...`);

        // Publica un evento en el bus.
        // Otro módulo (p.ej. 'logistics') podría estar escuchando este evento.
        ModuleBus.publish({
